            ...
            <div className="flex flex-wrap items-top mb-6">
              <div className="w-full lg:w-4/12 px-4 ml-auto">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <a className="text-gray-600 hover:text-gray-800 font-semibold block pb-2 text-sm cursor-pointer">Blog</a>
                  </li>
                  <li>
                    <a className="text-gray-600 hover:text-gray-800 font-semibold block pb-2 text-sm cursor-pointer">Github</a>
                  </li>
                  <li>
                    <a className="text-gray-600 hover:text-gray-800 font-semibold block pb-2 text-sm cursor-pointer">Liên hệ</a>
                  </li>
                </ul>
              </div>
              <div className="w-full lg:w-4/12 px-4">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <a className="text-gray-600 hover:text-gray-800 font-semibold block pb-2 text-sm cursor-pointer">Tìm việc nhanh</a>
                  </li>
                  <li>
                    <a className="text-gray-600 hover:text-gray-800 font-semibold block pb-2 text-sm cursor-pointer">Mẫu CV xin việc</a>
                  </li>
                  <li>
                    <a className="text-gray-600 hover:text-gray-800 font-semibold block pb-2 text-sm cursor-pointer">Viết đánh giá</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="text-sm text-gray-500 font-semibold py-1">
              Copyright © 2024 by Dung Danh Dan V2
            </div>
          </div>
        </div>
      </div>
